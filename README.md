...
<a href="https://vedhanthm.vercel.app">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=700&size=22&pause=1200&color=7EB2FF&center=true&vCenter=true&width=700&lines=CSE+%40+MIT+Bengaluru+%7C+CGPA%3A+9.19%2F10.0;IEEE+Access+First-Author+Researcher;Meta+Certified+Full-Stack+Developer;IBM+Certified+Data+Scientist;IIT+Ropar+AI+%26+ML+Intern+%F0%9F%94%AC;Top+850+%2F+40%2C000%2B+%E2%80%94+India+AI+Impact+Buildathon" alt="Typing SVG" />
</a>
...
class VedhanthM:
    def __init__(self):
        ...
        self.degree      = "B.Tech CSE  |  CGPA: 9.19 / 10.0  |  University Top Ranker"
        ...
        self.research    = "First-Author @ IEEE Access — SVD-based Model Compression"
...
> 🏅 **IEEE Access (First Author)** — Published Oct 2025
...
**ShreeKara Kalagruha** · *Jun 2025 – Present*
...
Semantic segmentation pipeline for real-time autonomous runway detection with live inference metrics & visual overlays, competing against hundreds of teams.
...
Hybrid multi-layer scam detection deploying 3 psychologically-designed AI personas to engage scammers and auto-extract threat intelligence (UPI IDs, bank accounts, phishing links).
...
Scalable TCP server handling multiple concurrent clients with thread-safe message broadcasting and graceful disconnection handling.
...
| 🎓 **University Top Ranker** | CGPA 9.19/10.0 — MIT Bengaluru |
